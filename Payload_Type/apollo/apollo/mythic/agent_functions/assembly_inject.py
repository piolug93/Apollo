...
class AssemblyInjectCommand(CommandBase):
    ...
    async def build_exeasm(self):
        ...
        shell_cmd = "dotnet build -c release -p:Platform=\"Any CPU\" {}/ExecuteAssembly/ExecuteAssembly.csproj -o {}/ExecuteAssembly/bin/Release/".format(agent_build_path.name, agent_build_path.name)
