...
class InlineAssemblyCommand(CommandBase):
    ...
    async def build_interop(self):
        ...
        shell_cmd = "dotnet build -c release -p:Platform=\"Any CPU\" {}/ApolloInterop/ApolloInterop.csproj -o {}/ApolloInterop/bin/Release/".format(agent_build_path.name, agent_build_path.name)
