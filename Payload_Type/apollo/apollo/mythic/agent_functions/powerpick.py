...
class PowerpickCommand(CommandBase):
    ...
    async def build_powershell(self):
        ...
        shell_cmd = "dotnet build -c release -p:Platform=\"Any CPU\" {}/PowerShellHost/PowerShellHost.csproj -o {}/PowerShellHost/bin/Release/".format(agent_build_path.name, agent_build_path.name)
