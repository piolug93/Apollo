...
#pragma warning restore 0649
        ...
        public override void Start()
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException($"Failed to inject loader into sacrificial process {info.Application}.");
                }
                ...
                {
                    throw new InvalidOperationException($"Injected assembly into sacrificial process: {info.Application}.\n Failed to connect to named pipe: {parameters.PipeName}.");
                }
